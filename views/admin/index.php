                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="userManagement.php" style="text-decoration: none">
                                    <div class="card-body">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="productManagement.php" style="text-decoration: none">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
