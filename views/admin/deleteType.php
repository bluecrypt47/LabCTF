...
<head>
    ...
    <title>Delete Product Type</title>
            ...
            <div id="content">
                ...
                if (isset($_GET['id'])) {
                    ...
                    if (isset($_REQUEST['deleteType'])) {
                        $query = "DELETE FROM `producttype` WHERE idType='$id'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Delete Product Type <strong><?php echo $type['nameType']; ?></strong></h1>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-10">
                                        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])) ?>" method="post">
                                            <div>
                                                <p>Are you sure you want to delete this Product Type?</p><br>
                                                <p>
                                                    <a href="productTypeManagement.php" class="btn btn-primary">Cancel</a>
                                                    <input type="submit" name="deleteType" value="Delete" class="btn btn-danger">
                                                </p>
                                            </div>
                                        </form>
                                    </div>
